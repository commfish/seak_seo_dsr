...
plot_biomass <- function(fit=fit,years=years,strata=strata,
  ...
  if (save == TRUE) {
    ggsave(paste0("figures/biomass_", mod_name, ".png"),plot=plot,
...
plot_p <- function(fit=fit,years=years,strata=strata,
  ...
  if (save == TRUE) {
    ggsave(paste0("figures/propK_", mod_name, ".png"),plot=plot,
           dpi=300,  height=6, width=7, units="in")
  }
  print(plot)
...
plot_index1<- function(fit=fit,years=years,strata=strata,
  ...
  if (save == TRUE) {
    ggsave(paste0("figures/index1_", mod_name, ".png"),plot=plot,
           dpi=300,  height=6, width=7, units="in")
  }
  print(plot)
...
plot_catch <- function(fit=fit,years=years,strata=strata,
  ...
  if (save == TRUE) {
    ggsave(paste0("figures/catch_", mod_name, ".png"),plot=plot,
           dpi=300,  height=6, width=7, units="in")
  }
  print(plot)
...
plot_discards <- function(fit=fit,years=years,strata=strata,
  ...
  if (save == TRUE) {
    ggsave(paste0("figures/discards_", mod_name, ".png"),plot=plot,
           dpi=300,  height=6, width=7, units="in")
  }
  print(plot)
...
#------------------------------------------------------------------------------
# process error
plot_pe <- function(fit = fit, sim_pe = pe, sim=TRUE, save=TRUE, mod_name="Testing") {
  samples <- rstan::extract(fit, permuted = TRUE)
  N<-years
  true_years = seq(year1,year1+years-1,1)
  ...
  if (save == TRUE) {
    ggsave(paste0("figures/proc_err_", mod_name, ".png"),plot=plot,
           dpi=300,  height=6, width=7, units="in")
  }
  print(plot)
